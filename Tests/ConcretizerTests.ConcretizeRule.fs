...
let [<Test>] ``Concretization of an equality concretizes both nodes`` () =
    ...
    concreteRule |> should equal (Set.ofList [ScopedVar ["root"; "x"] =@= ConstValue 1M])
...
let [<Test>] ``Concretization in rules is applied to all children`` () =
    ...
    concreteRule |> should equal (Set.ofList [ScopedVar ["root"; "child1"; "x"] =@= ConstValue 1M
                                              ScopedVar ["root"; "child2"; "x"] =@= ConstValue 1M])
...
let [<Test>] ``Concretization can be applied in grand-children rules`` () =
    ...
    concreteRule |> should equal (Set.ofList [ScopedVar ["root"; "child1"; "baby1"; "x"] =@= ConstValue 1M
                                              ScopedVar ["root"; "child1"; "baby2"; "x"] =@= ConstValue 1M
                                              ScopedVar ["root"; "child2"; "baby1"; "x"] =@= ConstValue 1M
                                              ScopedVar ["root"; "child2"; "baby2"; "x"] =@= ConstValue 1M
                                              ScopedVar ["root"; "child2"; "baby3"; "x"] =@= ConstValue 1M])
